...
class TrainerForRelationExtraction(Trainer):
    ...
    def prediction_loop(
        ...
        for b in range(len(re_labels)):
            ...
            for head, tail, label in zip(
                re_labels[b]["head"], re_labels[b]["tail"], re_labels[b]["label"]
            ):
                rel = {}
                rel["head_id"] = head
                rel["head"] = (
                    entities[b]["start"][rel["head_id"]],
